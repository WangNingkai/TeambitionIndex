<template>
  <div class="mdui-drawer mdui-drawer-close" id="main-drawer">
    <ul class="mdui-list" mdui-collapse="{accordion: true}">
      <router-link v-if="data.user===null || !data.user._id" :to="{name:'Login'}" class="mdui-list-item mdui-ripple" tag="li">
      ...
      <router-link to="/" class="mdui-list-item mdui-ripple" tag="li">
        ...
        <a href="javascript:void(0);" class="mdui-list-item-content">
          首页
        </a>
      </router-link>
      <li class="mdui-divider"></li>
      <li class="mdui-list-item mdui-ripple">
        <a href="javascript:void(0);" @click="toggleTheme()" class="mdui-list-item-icon mdui-icon material-icons">brightness_4</a>
        <a href="javascript:void(0);" @click="toggleTheme()"
           class="mdui-list-item-content">{{ data.darkMode ? '正常' : '暗黑' }}模式</a>
      </li>
      <li class="mdui-list-item mdui-ripple">
